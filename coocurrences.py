...
input_file = open('/home/bart/Documents/thesis/machine/data/CLEANED-SCAN/length_split/experiment5/dev.txt', 'r')
...
#coocurrences_normed = coocurrences / coocurrences.sum(axis=1)
